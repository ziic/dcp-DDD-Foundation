...
namespace dcp.DDD.Infrastructure.Data.EFAdapted.SuperTypes
{
    public abstract class AdaptedRepositoryBase<TData, TDomain> : RepositoryBase<TData>, IRepository<TDomain>, IAsyncRepository<TDomain>
        where TDomain : class
        where TData : class
    {
        ...
        public IEnumerable<TR> FindBy<TR>(Expression<Func<TDomain, bool>> predicate, Expression<Func<TDomain, TR>> projection, Expression<Func<TDomain, object>> includePathsFactory)
        {
        ...
        public IEnumerable<TR> FindBy<TR>(IQueryCommand<TDomain> queryObject, Expression<Func<TDomain, TR>> projection, Expression<Func<TDomain, object>> includePathsFactory)
        {
            throw new NotImplementedException();
        }
        ...
        public TR Find<TR>(object keyValue, Expression<Func<TDomain, TR>> projection, Expression<Func<TDomain, object>> includePathsFactory)
        {
            throw new NotImplementedException();
        }
        ...
        public TR Find<TR>(object keyValue, Expression<Func<TDomain, TR>> projection, IEnumerable<Expression<Func<TDomain, object>>> includePaths)
        {
            throw new NotImplementedException();
        }

        public TR Find<TR>(object[] keyValues, Expression<Func<TDomain, TR>> projection, Expression<Func<TDomain, object>> includePathsFactory)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<TDomain> FindAsync(object[] keyValues, IEnumerable<Expression<Func<TDomain, object>>> includePaths)
        {
            throw new NotImplementedException();
        }

        public Task<TDomain> FindAsync(object keyValue, IEnumerable<Expression<Func<TDomain, object>>> includePaths)
        {
            throw new NotImplementedException();
        }
        
        public Task<TR> FindAsync<TR>(object[] keyValues, Expression<Func<TDomain, TR>> projection)
        {
            throw new NotImplementedException();
        }

        public Task<TR> FindAsync<TR>(object keyValue, Expression<Func<TDomain, TR>> projection, Expression<Func<TDomain, object>> includePathsFactory)
        {
            throw new NotImplementedException();
        }

        public Task<TR> FindAsync<TR>(object keyValue, Expression<Func<TDomain, TR>> projection)
        {
            throw new NotImplementedException();
        }
        
        public Task<TR> FindAsync<TR>(object[] keyValues, Expression<Func<TDomain, TR>> projection, IEnumerable<Expression<Func<TDomain, object>>> includePaths)
        {
            throw new NotImplementedException();
        }
        
        public Task<TR> FindAsync<TR>(object keyValue, Expression<Func<TDomain, TR>> projection, IEnumerable<Expression<Func<TDomain, object>>> includePaths)
        {
            throw new NotImplementedException();
        }

        public Task<TR> FindAsync<TR>(object[] keyValues, Expression<Func<TDomain, TR>> projection, Expression<Func<TDomain, object>> includePathsFactory)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TDomain>> FindByAsync(IQueryCommand<TDomain> queryObject)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TR>> FindByAsync<TR>(IQueryCommand<TDomain> queryObject, Expression<Func<TDomain, TR>> projection)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TR>> FindByAsync<TR>(IQueryCommand<TDomain> queryObject, Expression<Func<TDomain, TR>> projection, Expression<Func<TDomain, object>> includePathsFactory)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TR>> FindByAsync<TR>(IQueryCommand<TDomain> queryObject, Expression<Func<TDomain, TR>> projection, IEnumerable<Expression<Func<TDomain, object>>> includePaths)
        {
            throw new NotImplementedException();
        }
        
        public Task<int> CountByAsync(IQueryCommand<TDomain> queryObject)
        {
            throw new NotImplementedException();
        }

        public Task<bool> AnyByAsync(IQueryCommand<TDomain> queryObject)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TDomain>> FindByAsync(Expression<Func<TDomain, bool>> predicate)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TR>> FindByAsync<TR>(Expression<Func<TDomain, bool>> predicate, Expression<Func<TDomain, TR>> projection)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TR>> FindByAsync<TR>(Expression<Func<TDomain, bool>> predicate, Expression<Func<TDomain, TR>> projection, Expression<Func<TDomain, object>> includePathsFactory)
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<TR>> FindByAsync<TR>(Expression<Func<TDomain, bool>> predicate, Expression<Func<TDomain, TR>> projection, IEnumerable<Expression<Func<TDomain, object>>> includePaths)
        {
            throw new NotImplementedException();
        }
        
        public Task<int> CountByAsync(Expression<Func<TDomain, bool>> predicate)
        {
            throw new NotImplementedException();
        }

        public Task<bool> AnyByAsync(Expression<Func<TDomain, bool>> predicate)
        {
            throw new NotImplementedException();
        }
    }
